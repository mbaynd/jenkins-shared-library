...
def scanDeployment(String targetURL) {
  ...
  sh "docker run --rm --user root -v $(pwd):/zap/wrk  -t ghcr.io/zaproxy/zaproxy zap-full-scan.py  -t http://34.210.224.141:8990/todos -r stable_full_scan_report.html || true"
